...
/**
 * @brief Return the APIC ID of the current processor.
 *
 * @return The 8-bit APIC identifier, or 0 if the LAPIC is unavailable.
 */
int lapicid(void)
{
    if (!lapic)
...
/**
 * @brief Start an application processor executing at a given address.
 *
 * Implements the universal startup algorithm from the Intel MP spec.
 *
...
/**
 * @brief Read a byte from the CMOS register space.
 *
...
/**
 * @brief Populate an ::rtcdate structure from CMOS registers.
 *
...
/**
 * @brief Read the real-time clock and translate it into calendar values.
 *
 * Handles the BCD-encoded fields provided by QEMU's emulated CMOS.
 *
