...
//             super_block.ninodes,
//             super_block.nlog,
//             super_block.logstart,
//             super_block.inodestart,
...
//  */
// int readi(struct inode *ip, char *dst, u32 off, u32 n)
// {
//     u32 m;
//
//     if (ip->type == T_DEV) {
...
//  */
// int writei(struct inode *ip, char *src, u32 off, u32 n)
// {
//     u32 m;
//
//     if (ip->type == T_DEV) {
...
//
//     for (u32 off = 0; off < dp->size; off += sizeof(de)) {
